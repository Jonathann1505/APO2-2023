...
public class Punto_2 {
	...
	/*2.	Ejercicio dos: Crea un programa en la cual se debe crear una clase llamada Persona que siga las siguientes condiciones:
a.	Sus atributos son: nombre, edad, DNI, sexo (H hombre, M mujer), 
...
b.	Por defecto, todos los atributos menos el DNI 
serán valores por defecto según su tipo (0 números, cadena vacía para String, etc.). 
Sexo sera hombre por defecto, usa una constante para ello.
c.	Se implantarán varios constructores:
...
que 20, la función devuelve un -1, si devuelve un número entre 20 y 25 (incluidos), 
significa que está por debajo de su peso ideal la función devuelve un 0  y si devuelve un valor 
mayor que 25 significa que tiene sobrepeso, la función devuelve un 1. Te recomiendo que uses 
...
variables pedidas por teclado, el segundo objeto obtendrá 
